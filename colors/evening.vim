...
if !exists('s:evening_loaded')
	...
	" Actually sets the highlighting for the given group
	if &tgc
...
if !exists('s:evening_loaded')
	" Default GUI Colours
	let s:foreground      = <SID>rgb("bbbbbb")
	" let s:background      = <SID>rgb("000000")
	let s:background      = <SID>rgb("1C1C1C")
	let s:selection       = <SID>rgb("404040")
	let s:line            = <SID>rgb("252525")
	let s:activeline      = <SID>rgb("353535")
	let s:non_text        = <SID>rgb("252525")
	let s:comment         = <SID>rgb("757575")
	let s:window          = <SID>rgb("252525")
	let s:tab_bg          = <SID>rgb("353535")
	let s:tab_fg          = <SID>rgb("bbbbbb")
	let s:linenr_bg       = <SID>rgb("252525")
	let s:linenr_fg       = <SID>rgb("656565")
	let s:statusline_bg   = <SID>rgb("303030")
	let s:statusline_fg   = <SID>rgb("65aaca")
	let s:cursor_bg       = <SID>rgb("555555")

	let s:red             = <SID>rgb("cc6666")
	let s:lyme            = <SID>rgb("afdf00")
	let s:peach           = <SID>rgb("cca68e")
	let s:orange          = <SID>rgb("de935f")
	let s:wine            = <SID>rgb("af8787")
	let s:purple          = <SID>rgb("b14cc2")
	let s:yellow          = <SID>rgb("f0c674")
	let s:green           = <SID>rgb("95bf68")
	let s:aqua            = <SID>rgb("20af75")
	let s:olive           = <SID>rgb("afaf4f")
	let s:blue            = <SID>rgb("6ad6e5")
	let s:lightblue       = <SID>rgb("65aaca")

	" Language-specific colors
	let s:diffbackground = <SID>rgb("494e56")

	" Console 256 Colours
	if !&tgc
		let s:background  = <SID>rgb("252525")
		let s:window      = <SID>rgb("252525")
		let s:line        = <SID>rgb("252525")
		let s:selection   = <SID>rgb("404040")
	end
