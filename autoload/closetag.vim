...
" Buffer variables
fun! s:InitBuf()
    call closetag#Declare('b:did_ftplugin_closetag', 1)
    call closetag#Declare('b:closetag_emptyTags', '^\(area\|base\|br\|col\|command\|embed\|hr\|img\|input\|keygen\|link\|meta\|param\|source\|track\|wbr\)$')
    call closetag#Declare('b:closetag_firstWasEndTag', 0)
    call closetag#Declare('b:closetag_html_mode', 1)
    call closetag#Declare('b:closetag_haveAtt', 0)
    call closetag#Declare('b:closetag_use_xhtml', &filetype == 'xhtml' ? 1 : 0)
endf
